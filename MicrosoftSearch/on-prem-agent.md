...
7. Na caixa de diálogo permissões, selecione adicionar opção. Na caixa de diálogo seleção do usuário, escreva: **NT Service\GcaHostService** e clique em **OK**. Não clique no botão Verificar **Nomes.**
