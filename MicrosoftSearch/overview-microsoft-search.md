...
Se as sugestões na caixa de pesquisa não correspondem ao que eles estão procurando, clicar em Enter abre a lista completa de resultados. Eles podem usar metadados, como quem modificou o item pela última vez e quando e onde os itens estão localizados, além de visualizá-los para determinar se é o que eles estão procurando.
...
## <a name="which-apps-currently-have-microsoft-search"></a>Quais aplicativos possuem a Pesquisa da Microsoft atualmente? 
Com o tempo, a Pesquisa da Microsoft estará disponível em mais e mais aplicativos no Microsoft 365.
...
Somente usuários com contas ativas podem usar a Pesquisa da Microsoft, e eles devem estar **conectados**.
...
A seguir, uma visão geral do tipo de resultados que os usuários recebem em cada aplicativo:

**Outlook**: emails, anexos e pessoas em sua organização.

**Aplicativos do Office no Windows**: ações no aplicativo, pessoas na sua organização e na Web pública, arquivos, explicações de palavras, correspondências para a consulta dentro do arquivo ou no conteúdo de ajuda, conteúdo na Web pública. Arquivos do Word, Excel, PowerPoint, Visio e OneNote podem ser encontrados.

**OneDrive**: arquivos do mesmo tipo que no SharePoint podem ser encontrados.

**SharePoint**: arquivos, pastas, pessoas em sua organização, organogramas, sites, páginas de site, notícias, listas e itens de lista. Se definido, respostas a perguntas comuns, indicadores que levam a informações autoritativas, locais de mapa e ferramentas. Saiba quais tipos de arquivos você pode encontrar.
...
## <a name="microsoft-search-in-bing"></a>Pesquisa da Microsoft no Bing 
Quando os usuários pesquisam no Bing, eles obtêm resultados da Web e resultados de dentro da sua organização, quando eles estão conectados ao Office 365.
