...
1. No Centro de administração do Microsoft 365, acesse **Settings**  >  [**Search & intelligence**](https://admin.microsoft.com/Adminportal/Home#/MicrosoftSearch).
...
Se você quiser saber mais sobre como seus usuários usarão a Pesquisa da Microsoft, consulte os seguintes artigos:
