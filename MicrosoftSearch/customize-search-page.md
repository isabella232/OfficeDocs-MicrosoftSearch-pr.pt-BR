...
OU  
Para editar uma vertical, selecione-a na lista.
...
1. Para adicionar um tipo de resultado, selecione **Adicionar**.  
OU  
Para editar um tipo de resultado, selecione o tipo de resultado na lista.
