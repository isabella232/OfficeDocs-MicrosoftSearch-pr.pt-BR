...
O conector Oracle SQL Graph permite que sua organização descubra e indexe dados de um banco de dados Oracle local. O conector indexa o conteúdo especificado na Pesquisa da Microsoft. Para manter o índice atualizado com dados de origem, ele oferece suporte a rastreamentos periódicos completos e incrementais. Com o conector SQL Oracle, você também pode restringir o acesso aos resultados da pesquisa para determinados usuários.
...
Este artigo é para qualquer pessoa que configure, executa e monitore um conector Oracle SQL Graph. Ele complementa o processo de instalação geral e mostra instruções que se aplicam apenas ao conector Oracle SQL Graph. Este artigo também inclui informações sobre Solução de [Problemas](#troubleshooting) e [Limitações.](#limitations)

## <a name="before-you-get-started"></a>Antes de começar

### <a name="install-the-graph-connector-agent"></a>Instalar o agente de conector do Graph

Para acessar seus dados de terceiros locais, você deve instalar e configurar o agente de conector do Graph. Consulte [Instalar o agente de conector do Graph](on-prem-agent.md) para saber mais.  
...
Para conectar seu conector de SQL Oracle a uma fonte de dados, você deve configurar o servidor de banco de dados que deseja rastrear e o agente de conector do Graph local. Em seguida, você pode se conectar ao banco de dados com o método de autenticação necessário.
...
* **ID do Azure Active Directory (AAD) : no Azure AD,** cada usuário ou grupo tem uma ID de objeto que se parece com 'e0d3ad3d-0000-1111-2222-3c5f5c52ab9b'
...
* As ACLs só têm suporte usando um Nome de Entidade de Usuário (UPN), o Azure Active Directory (Azure AD) ou o Active Directory Security.
